  ...
  return (
    <main className="relative min-h-screen bg-gignite-bg px-4 py-10 font-body text-gignite-text lg:px-16 lg:py-16">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[460px] flex-col gap-10 lg:max-w-[1320px] lg:flex-row lg:items-start lg:gap-20">
        ...
        <div className="flex w-full flex-col gap-5 rounded-[30px] border border-black/[0.08] bg-gignite-card p-6 shadow-[0_18px_46px_rgba(44,44,44,0.13)] lg:flex-1 lg:border-0 lg:bg-transparent lg:p-0 lg:shadow-none">
